...
A simple and responsive Notes App built using HTML, CSS, and JavaScript. The application allows users to create, edit, delete, and search notes using a clean and interactive interface.
